...
# 9. bind_rows() vs. bind_rows() ----------------------------------------------
# Practice: why bind_rows() rather than bind_rows() ---------------------------
??bind_rows


# Creating 3 data.frames with the same 3 columns, each with 3 data rows.
# using bind_rows to combine them
...
# using bind_rows to combine them to see what happens
