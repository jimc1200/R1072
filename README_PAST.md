...
# Course designs
1. 自107-2始，本門課專為「資料新聞實作」開設，強調如何使用R語言產製資料新聞。著重獲取資料、視覺化和形成報導。如果同學的修課目的是「想學程式」，請改修每學年度上學期的課。 
2. 修課對象：以新聞所學生優先和選修數位新聞跨域學分學程的學生為主。每學期最多25人。由於本課程的目標為「資料新聞」，所以開學後將以新聞所、曾選修數位新聞跨域學程、生傳／社會／政治大學部的順位加選。如以學習「寫程式」為目的，建議選修管院與共教中心的程式設計課程，或選修108-1於經濟系（所）或新聞所開設的課程。
3. 本門課以R作為核心程式語言，講授如何用R爬取開放資料、如何用R靈活處理資料；做清洗、整合及探索；如何用R處理線型回歸、邏輯函數、基礎文本分析、群聚分析。 本門課將另外講授如何用第三方軟體與服務Google Sheet與Tableau整理和視覺化資料，以強化資料的概念與視覺化的日常運用。 
4. 本學期強調在政治傳播議題的分析與地理資訊的應用。課程報導議題將鎖定在2018年九合一選舉、PM2.5、591租屋網與實價登錄的不均、醫療與教育地域性不均問題。 
5. 課程報導包含有訪談內容以驗證實作成果，並需要發表至指定新聞平台。 
6. 課程中安排有期中考確實驗收學生實作能力。課程亦考驗學生程式的應用能力：學生需要自行涉獵一個套件或分析案例（Datacamp, Online cases, or packages）以顯示其有能力在課後持續發展。
7. 新聞所學生如果想以計算傳播學方法作為論文組畢業，請二上接續選修進階課程。 
8. 本學期共教中心蔡老師亦開設有二門程式設計課程，如對資料新聞實作本身無特殊興趣者，推薦選修共教中心課程培養資料分析能力。 
