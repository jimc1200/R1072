...
# The data: data.frame and vector
* 從這兩個網頁擷取收入與人口數資料
* https://www.ptt.cc/bbs/Gossiping/M.1535459575.A.54D.html
...
## Combining vectors to a data.frame

```{r}
df <- data.frame(county, income, population)
# View(df)
```
