...
# Data by counties in Taiwan

```{r}
income <- c(70100, 51300, 51100, 48400, 47600)
county <- c("台北", "新北", "桃園", "高雄", "台中")
population <- c(2.6, 3.9, 2.2, 2.7, 2.8)
area <- c(271.8, 2052.5, 1221, 2951.9, 2214.9)
```


## building a data.frame
```{r}
df <- data.frame(income, county, population)
# View(df)
```
...
* 那在進出口貿易的例子中，要如何先就出口再入口的比例，由大而小排列？
