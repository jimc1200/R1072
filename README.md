...
* After creating a new project, download [R01_1 loading data.Rmd](R01_1 loading data.Rmd) and [R01_2 vector.Rmd](R01_2 vector.Rmd), then drag into your project folder.
